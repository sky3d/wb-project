...
export class initialDb1663875144893 implements MigrationInterface {
  name = 'initialDb1663875144893'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "verse" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "renga_id" character varying NOT NULL, "renga_part" integer NOT NULL DEFAULT '0', "name" character varying NOT NULL, "meta" jsonb, "number" integer NOT NULL, "season" "public"."verse_season_enum" NOT NULL DEFAULT '0', "format" "public"."verse_format_enum" NOT NULL DEFAULT '3', "topics" jsonb, "line1" character varying NOT NULL, "line2" character varying, "line3" character varying, "active" boolean NOT NULL, CONSTRAINT "PK_1bf192a2ee81fa999f9a75939e4" PRIMARY KEY ("id"))`)
